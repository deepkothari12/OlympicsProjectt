...
if user_menu == 'Athlete wise Analysis':
    ...
    #he value 0.0985 suggests that the density (or probability mass) at age 22.35 is around 0.0985, 
    # meaning that this age range has a relatively high occurrence compared to others in the dataset.
